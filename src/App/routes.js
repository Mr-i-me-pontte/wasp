...
import HomePage from "./pages/Dapp/HomePage/Home/NewHome";
...
const routes = [
    ...
    { path: "dapp/home", element: <DappHome />, name: "Home", fa: "home" },
    { path: "dapp/homepage", element: <HomePage />, name: "Home", fa: "home" },
