...
type EagerTokens = {
  readonly [__modelMeta__]: {
    identifier: ManagedIdentifier<Tokens, 'id'>;
...
export declare type Tokens = LazyLoading extends LazyLoadingDisabled ? EagerTokens : LazyTokens

export declare const Tokens: (new (init: ModelInit<Tokens>) => Tokens) & {
  copyOf(source: Tokens, mutator: (draft: MutableModel<Tokens>) => MutableModel<Tokens> | void): Tokens;
}
